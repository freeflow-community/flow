...
/// DEBUG-only QA affordance, mirroring iOS's identical helper: when launched
/// with FLOW_DEBUG_EMAIL + FLOW_DEBUG_PASSWORD in the environment, sign in
/// automatically once bootstrap resolves to signed-out. Lets a debug build be
/// driven end-to-end without a UI text-input tool. Compiled out of release.
